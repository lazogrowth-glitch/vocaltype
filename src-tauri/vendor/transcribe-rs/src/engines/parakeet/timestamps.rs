...
pub fn group_tokens_into_words(timestamped_result: &TimestampedResult) -> Vec<WordBoundary> {
    let words = convert_to_hierarchical_word_segments(timestamped_result);
